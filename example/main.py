...
if __name__ == "__main__":
    ...
    init(root_path=args.root_path, app="test", layers=["ycappuccino_storage","ycappuccino_endpoints","ycappuccino_endpoints_storage"], bundle_prefix="ycappuccino", port=args.port)
    # Run the server
    start()
